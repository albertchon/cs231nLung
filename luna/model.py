...
class LungSystem(object):
    ...
    def setup_unet_system(self):
        ...
        resize7 = tf.image.resize_images(conv5, [128, 128]) # ? * 128 * 128 * 256
        ...
        resize8 = tf.image.resize_images(conv7, [256, 256]) # ? * 256 * 256 * 128
        ...
        resize9 = tf.image.resize_images(conv8, [512, 512]) # ? * 512 * 512 * 64
